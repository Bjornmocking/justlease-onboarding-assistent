...
function buildSystemInstruction(passages, werkwijze) {
  return [
    ...
    '- Websitepagina\'s (verkoopargumenten) zijn geen voorwaarden. Bij tegenspraak met de Aanvullende Voorwaarden gaan de voorwaarden voor. Noem het verschil kort. Uitzondering: waar de werkwijze zegt dat de website de bron is (vervangend vervoer per servicepakket en de flexibele kilometerbundel), gaat de website voor.',
    '- Prijzen: noem alleen prijzen die in de passages staan en verwijs voor de maandprijs van een auto naar de website (configurator).',
